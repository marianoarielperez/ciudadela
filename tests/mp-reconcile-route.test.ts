...
const summary = { paymentsRecovered: 1, paymentsInbox: 0, paymentsSkipped: 0, paymentsForeign: 0, debitsRecovered: 0, debitsInbox: 0, debitsSkipped: 0, subscriptionsSynced: 2, subscriptionsDrifted: 0, orphanCreated: 0, orphanCancelled: 0, orphanPreapprovals: 0, amountDivergent: 0, planDivergent: 0, deferred: 0, errors: [] as string[], errorsOmitted: 0 };
